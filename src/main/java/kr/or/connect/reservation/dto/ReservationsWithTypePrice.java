...
public class ReservationsWithTypePrice {
	...
	private List<MyReservationPrice> ticketTypePrice;
	...
	public List<MyReservationPrice> getTicketTypePrice() {
		return ticketTypePrice;
	}
	public void setTicketTypePrice(List<MyReservationPrice> ticketTypePrice) {
		this.ticketTypePrice = ticketTypePrice;
	}
	@Override
	public String toString() {
		return "ReservationsWithTypePrice [cancelYn=" + cancelYn + ", createDate=" + createDate + ", displayInfo="
				...
				+ ", reservationTelephone=" + reservationTelephone + ", totalPrice=" + totalPrice + ", ticketTypePrice="
				+ ticketTypePrice + "]";
	}
