...
<body>
    <div id="container">
        <div class="header">
            <header class="header_tit">
                ...
                <a href="" class="btn_my"> <span class="viewReservation" title="예약확인">
        ...
        <div class="event">
                    ...
                    <div class="container_visual">
                        ...
                        <div>
                            <div class="container_visual">
                                ...
                                <ul class="visual_img">
                                    <c:forEach items="${promotionImgs}" var="promotionImg">
                                        <li class="item" style="background-image: url(download/${promotionImg.fileInfoId});">
                                        </li>
                                    </c:forEach>
                                </ul>
                            </div>
            ...
            <div class="section_event_tab">
                <ul class="event_tab_lst tab_lst_min">
                    ...
                    <c:forEach items="${CategoryTabs}" var="CategoryTabs">
                        <li class="item" data-category="${CategoryTabs.id}">
                            <a class="anchor"> <span>${CategoryTabs.name}</span> </a>
                        </li>
                    </c:forEach>
                </ul>
            </div>
            <div class="section_event_lst">
                <div class="wrap_event_box">
                    ...
                    <!-- 더보기 -->
                    <div class="more">
                        <button class="btn" data-pageCount="1"><span>더보기</span></button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="rv-template" id="sectionCount">
        바로 예매 가능한 행사가 <span class="pink">{count}개</span> 있습니다
    </script>

    <script type="text/javascript" src="resources/script/mainpage.js?ver=<%=(new Random()).nextInt()%>"></script>
</body>
