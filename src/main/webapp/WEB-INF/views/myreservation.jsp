...
<body>
	<div id="container">
		<div class="header">
			<header class="header_tit">
				<h1 class="logo">
					<a href="http://localhost:8080" class="lnk_logo" title="네이버"> <span
							class="spr_bi ico_n_logo">네이버</span> </a>
					<a href="http://localhost:8080" class="lnk_logo" title="예약"> <span
			...
			<div class="section_my">
				...
				<div class="wrap_mylist">
					<ul class="list_cards" ng-if="bookedLists.length > 0">
						...
						<li class="card used used_ticket_target">
							<div class="link_booking_details">
								<div class="card_header">
									<div class="left"></div>
									<div class="middle">
	...
	<!--// 취소 팝업 -->
	<script type="rv-template" id="confirmedTicketTemplate">
				...
				<div class="card_body">
					...
					<div class="middle">
						<div class="card_detail">
							<em class="booking_number">No.<span>{reservationInfoId}</span></em>
							...
							<div class="booking_cancel">
								<button class="btn cancel_btn"><span>취소</span></button>
							</div>
	...
	<script type="rv-template" id="ticketCountTemplate">
			{ticketType} {count}장 - {typePrice}원<br>
	</script>

	<script type="rv-template" id="usedTicketTemplate">
		<article class="card_item">
			<a href="#" class="link_booking_details">
				<div class="card_body">
					<div class="left"></div>
					<div class="middle">
						<div class="card_detail">
							...
							<div class="booking_cancel">
								<a href="/reservations/{reservationInfoId}/comments">
									<button class="btn">
										<span>
											예매자 리뷰 남기기
										</span>
	...
	<script type="rv-template" id="canceledTicketTemplate">
		<article class="card_item">
			<a href="#" class="link_booking_details">
				<div class="card_body">
					<div class="left"></div>
	...
	<script type="text/javascript" src="resources/script/myreservation.js?ver=<%=(new Random()).nextInt()%>"></script>
