                ...
                <div class="section_visual">
                    ...
                    <div class="pagination">
                        ...
                        <div class="figure_pagination">
                            <span id="current_slide_number" class="num">1</span>
                            <span id="total_slide_number" class="num off">/ <span>2</span></span>
                        </div>
                    </div>
                ...
                <div class="section_event">
                    <div class="event_info_box">
                        ...
                        <div class="event_info">
                            <div class="in_dsc">
                                [네이버예약 특별할인]<br>
                                <span class="discount_info_wrap"></span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="section_btn"> 
                    <button type="button" class="bk_btn" onclick=""> 
                    ...
                    <div class="review_box">
                        ...
                        <div class="short_review_area">
                            <div class="grade_area">
                                ...
                                <span class="join_count"><em class="green">건</em> 등록</span>
                            </div>
...
<!-- -------------------------리뷰 4개--------------------------- -->
    ...
    <script type="rv-template" id="product_image_list">
        <li class="item" style="width: 414px;"> 
            <img alt="상품이미지" class="img_thumb" src="download/{{fileInfoId}}"> 
    ...
    <script type="rv-template" id="product_content">
        {{productContent}}
    </script>

    <script type="rv-template" id="discount_info">
        {{priceTypeName}}석 {{discountRate}}%
    </script>

    <script type="rv-template" id="without_discount_info">
        특별할인 정보가 없습니다.
    </script>

    <script type="rv-template" id="comment_count">
        {commentCount}
    </script>

    <script type="rv-template" id="comment_list">
        <li class="list_item">
            <div>
    ...
    <script type="rv-template" id="comment_image_list">
        <li class="list_item">
            <div>
                <div class="review_area">
                    <div class="thumb_area">
                        <a href="#" class="thumb" title="이미지 크게 보기"> 
                            <img width="90" height="90" class="img_vertical_top" src="download/{fileInfoId}" alt="리뷰이미지"> 
                        </a> 
                        <span class="img_count" style="display:none">
                            1
                        </span>                          
                    </div>
                    <h4 class="resoc_name"></h4>
    ...
    <script type="rv-template" id="location_contents">
        <div class="box_store_info no_topline">
            <a href="" class="store_location" title="지도웹으로 연결">
                <img class="store_map img_thumb" alt="map" src="download/{fileInfoId}">
            ...
            <div class="store_info">
                ...
                <div class="lst_store_info_wrap">
                    <ul class="lst_store_info">
                        <li class="item"> <span class="item_lt"> <i class="fn fn-call2"></i> <span class="sr_only">전화번호</span> </span> <span class="item_rt"> <a href="" class="store_tel">{{telephone}}</a></span> </li>
                    </ul>
                </div>
            </div>
    ...
    <script type="text/javascript" src="resources/script/detail.js?ver=<%=(new Random()).nextInt()%>"></script>
