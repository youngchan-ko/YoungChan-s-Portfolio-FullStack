...
<html lang="ko">
    ...
    <body>
            ...
            <div class="ct">
                <div class="ct_wrap">
                    <div class="top_title review_header">
                        ...
                        <a href="http://localhost:8080/myreservation?reservationEmail=${reservationEmail }" class="btn_back" title="이전 화면으로 이동"> <i class="fn fn-backward1"></i> </a>
                        <h2><span class="title">${data[0].description}</span></h2>
                    ...
                    <div class="review_contents write">
                        ...
                        <a href="#comment_text" class="review_write_info">
                            <span class="middot">
                        ...
                        <textarea id="comment_text" cols="30" rows="10" class="review_textarea" maxlength="400"></textarea>
                    </div>
                    <!-- //리뷰 입력 -->
                    ...
                    <div class="review_write_footer_wrap">
                        ...
                        <input type="hidden" id="productId" value="${data[0].productId}">
                        <input type="hidden" id="reservationInfoId" value="${data[0].reservationInfoId}">
                        <!-- 리뷰 포토 -->
        ...
        <script type="text/javascript" src="/../resources/script/reviewwrite.js?ver=<%=(new Random()).nextInt()%>"></script>
    </body>
</html>
