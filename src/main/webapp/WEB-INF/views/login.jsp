...
<link rel="stylesheet"
	href="resources/css/bookinglogin.css?ver=<%=(new Random()).nextInt()%>">
</head>
<body class="biz ko">
            ...
            <div class="booking_login">
                <h1 class="login_header">
                    <a href="http://localhost:8080/"
                        class="nbooking_logo spr_bi txt_logo"> <span
                ...
                <div>
                    <form name="confirm_form" class="ng-pristine ng-valid" id="form1"
                        ...
                        <button type="button" form="form1" class="login_btn confirm">
	...
	<footer aria-hidden="false">
		...
		<div class="gototop" aria-hidden="false">
			<a href="http://localhost:8080/login" class="lnk_top"> 
                <span class="lnk_top_text" translate="CM-TOP">
                    TOP
                </span>
			</a>
		</div>
		...
		<div id="footer" class="footer">
			<ul class="lst_nav">
				<!---->
				<li class="lnk_item">
                    <a href="" class="anchor _logout_link">
						<span translate="CM-LOGIN">
                           	로그인
                        </span>
                    </a>
                </li>
				...
				<li class="lnk_item">
                    <a href="" class="anchor"> 
                        <span translate="CM-WHOLE_SERVICE">
                            전체서비스
                        </span>
                    </a>
                </li>
			...
			<dl class="box_vcard">
				<dt class="tit_dt">
					<a href="#" class="lnk_naver" title="펼쳐보기"> 
                        <span translate="CM-NAVER_INC">
                            (주)네이버 사업자정보
                        </span> 
                        <i class="fn fn-down2" aria-hidden="true">
			...
			<ul class="lst_link">
				<li class="item">
                    <a class="anchor" ui-sref="policy" href="#"> 
                        <span translate="CM-TERMS">
                            이용약관
                        </span>
                    </a>
                </li>
				<li class="item">
                    <a class="#">
						<strong class="policy_em" translate="CM-PRIVACY_POLICY">
                            개인정보처리방침
                        </strong>
                    </a>
                </li>
				<li class="item">
                    <a href="#" class="anchor"> 
                        <span translate="CM-CUSTOMER_CENTER_NBOOKING">
                            네이버 예약 고객센터 
                        </span>
                    </a>
                </li>
			</ul>
			<span class="copyright" translate="CM-COPYRIGHT_NAVER">
                © NAVER Corp.
            </span>
		</div>
		<!---->
    ...
    <script type="text/javascript" src="resources/script/login.js?ver=<%=(new Random()).nextInt()%>"></script>
</body>
